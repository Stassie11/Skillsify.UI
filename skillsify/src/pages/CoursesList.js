...
export default function CoursesList() {
    return (
        ...
        <div className="flex-1 mt-30 p-4" style={{width: "400px", height: "200px"}}>
        
        <div
  class="block rounded-lg bg-white">
  <div
    class="relative overflow-hidden bg-pinkcustom"
   >
    <img
      class="rounded-t-lg"
      ...
      alt="" />
      <div
        class="absolute bottom-0 left-0 right-0 top-0 h-full w-full"></div>
  </div>
  <div class="p-6">
    <h5
